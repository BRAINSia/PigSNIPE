...
try:
    ...
    shutil.copy(brains_path / "lib" / "libBRAINSFitLib.a", brains_binaries_dir)
    shutil.copy(brains_path / "lib" / "libBRAINSResampleLib.a", brains_binaries_dir)
    shutil.copy(brains_path / "lib" / "libBRAINSConstellationLandmarksTransformLib.a", brains_binaries_dir)
    shutil.copy(brains_path / "lib" / "liblandmarksConstellationAlignerLib.a", brains_binaries_dir)